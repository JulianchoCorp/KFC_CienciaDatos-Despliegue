...
app = dash.Dash(external_stylesheets=["/static/assets/html-components.css", dbc.themes.BOOTSTRAP])

###------------DATOS
server = app.server
cwd = os.getcwd()
Final_dir = cwd + "/static/Datos/Final/"
graphs_dir = cwd + "/static/graphs/"
df = pd.read_csv(Final_dir + "final_Datos_presente.csv")
df_futuro = pd.read_csv(Final_dir + "final_Datos_futuro.csv")
logo_image = "/static/assets/kfc.png"
